...
class PatientManagementTest(BasicTests):
    ...
    def test_create_patient(self):
        response = self.createpatient(100000057,'Joe',30,'2020-06-26','Parklane secunderabad','semi_sharing','telangana','hyderabad')
        print(response)
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_patient_wrong(self):
        response = self.createpatient(100000023,'Joe',30,'Parklane secunderabad','2020-76-26','semi_sharing','telangana','hyderabad')
        print(response)
        self.assertEqual(response.status_code, 200)
        #self.assertIn(b'create_patient',response.data)
    ...
    def test_update_patient(self):
        response = self.updatepatient(100000001,'malik',99,'2013-11-11','semi_sharing','as rao nagar','ap','hyd') 
        self.assertEqual(response.status_code, 200)
